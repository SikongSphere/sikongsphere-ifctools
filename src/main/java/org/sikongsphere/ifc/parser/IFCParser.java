...
public class IFCParser extends Parser {
	...
	public static final int
		T__0=1, T_DATA=2, T_END=3, T_ENDSEC=4, T_FALSE=5, T_FILE_DESCRIPTION=6, 
		T_FILE_NAME=7, T_FILE_SCHEMA=8, T_HEADER=9, T_NULL=10, T_TRUE=11, T_ISO_10303_21=12, 
		T_ADD=13, T_COLON=14, T_COMMA=15, T_PIPE=16, T_DIV=17, T_DOT=18, T_DOT2=19, 
		T_DOLLAR=20, T_EQUAL=21, T_EQUAL2=22, T_NOTEQUAL=23, T_NOTEQUAL2=24, T_GREATER=25, 
		T_GREATEREQUAL=26, T_LESS=27, T_LESSEQUAL=28, T_MUL=29, T_OPEN_B=30, T_OPEN_P=31, 
		T_OPEN_SB=32, T_CLOSE_B=33, T_CLOSE_P=34, T_CLOSE_SB=35, T_SEMICOLON=36, 
		T_SUB=37, T_WELL=38, L_ID=39, L_S_STRING=40, L_D_STRING=41, L_INT=42, 
		L_DEC=43, L_WS=44, L_M_COMMENT=45, L_S_COMMENT=46, L_FILE=47;
	public static final int
		RULE_ifcmodel = 0, RULE_header = 1, RULE_data = 2, RULE_dataItem = 3, 
		RULE_isoTag = 4, RULE_expr = 5, RULE_exprAtom = 6, RULE_exprFunc = 7, 
		RULE_exprFuncParams = 8, RULE_funcParam = 9, RULE_ident = 10, RULE_string = 11, 
		RULE_intNumber = 12, RULE_decNumber = 13, RULE_scientificCountingNumber = 14, 
		RULE_boolLiteral = 15, RULE_nullConst = 16;
	private static String[] makeRuleNames() {
		return new String[] {
			"ifcmodel", "header", "data", "dataItem", "isoTag", "expr", "exprAtom", 
			"exprFunc", "exprFuncParams", "funcParam", "ident", "string", "intNumber", 
			"decNumber", "scientificCountingNumber", "boolLiteral", "nullConst"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, null, "T_DATA", "T_END", "T_ENDSEC", "T_FALSE", "T_FILE_DESCRIPTION", 
			"T_FILE_NAME", "T_FILE_SCHEMA", "T_HEADER", "T_NULL", "T_TRUE", "T_ISO_10303_21", 
			"T_ADD", "T_COLON", "T_COMMA", "T_PIPE", "T_DIV", "T_DOT", "T_DOT2", 
			"T_DOLLAR", "T_EQUAL", "T_EQUAL2", "T_NOTEQUAL", "T_NOTEQUAL2", "T_GREATER", 
			"T_GREATEREQUAL", "T_LESS", "T_LESSEQUAL", "T_MUL", "T_OPEN_B", "T_OPEN_P", 
			"T_OPEN_SB", "T_CLOSE_B", "T_CLOSE_P", "T_CLOSE_SB", "T_SEMICOLON", "T_SUB", 
			"T_WELL", "L_ID", "L_S_STRING", "L_D_STRING", "L_INT", "L_DEC", "L_WS", 
	...
	@Override
	public String getGrammarFileName() { return "IFC.g4"; }
	...
	public static class IfcmodelContext extends ParserRuleContext {
		...
		public TerminalNode T_SEMICOLON() { return getToken(IFCParser.T_SEMICOLON, 0); }
		...
		public TerminalNode T_END() { return getToken(IFCParser.T_END, 0); }
		public TerminalNode T_SUB() { return getToken(IFCParser.T_SUB, 0); }
		public IfcmodelContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_ifcmodel; }
		@Override
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof IFCVisitor ) return ((IFCVisitor<? extends T>)visitor).visitIfcmodel(this);
	...
	public static class HeaderContext extends ParserRuleContext {
		...
		public TerminalNode T_HEADER() { return getToken(IFCParser.T_HEADER, 0); }
		public List<TerminalNode> T_SEMICOLON() { return getTokens(IFCParser.T_SEMICOLON); }
		public TerminalNode T_SEMICOLON(int i) {
			return getToken(IFCParser.T_SEMICOLON, i);
		}
		public TerminalNode T_FILE_DESCRIPTION() { return getToken(IFCParser.T_FILE_DESCRIPTION, 0); }
		public List<TerminalNode> T_OPEN_P() { return getTokens(IFCParser.T_OPEN_P); }
		public TerminalNode T_OPEN_P(int i) {
			return getToken(IFCParser.T_OPEN_P, i);
		}
		public List<TerminalNode> T_CLOSE_P() { return getTokens(IFCParser.T_CLOSE_P); }
		public TerminalNode T_CLOSE_P(int i) {
			return getToken(IFCParser.T_CLOSE_P, i);
		}
		public TerminalNode T_FILE_NAME() { return getToken(IFCParser.T_FILE_NAME, 0); }
		public TerminalNode T_FILE_SCHEMA() { return getToken(IFCParser.T_FILE_SCHEMA, 0); }
		public TerminalNode T_ENDSEC() { return getToken(IFCParser.T_ENDSEC, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof IFCVisitor ) return ((IFCVisitor<? extends T>)visitor).visitHeader(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class DataContext extends ParserRuleContext {
		public TerminalNode T_DATA() { return getToken(IFCParser.T_DATA, 0); }
		public List<TerminalNode> T_SEMICOLON() { return getTokens(IFCParser.T_SEMICOLON); }
		public TerminalNode T_SEMICOLON(int i) {
			return getToken(IFCParser.T_SEMICOLON, i);
		}
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof IFCVisitor ) return ((IFCVisitor<? extends T>)visitor).visitData(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class DataItemContext extends ParserRuleContext {
		...
		public TerminalNode T_WELL() { return getToken(IFCParser.T_WELL, 0); }
		public TerminalNode T_EQUAL() { return getToken(IFCParser.T_EQUAL, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof IFCVisitor ) return ((IFCVisitor<? extends T>)visitor).visitDataItem(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class IsoTagContext extends ParserRuleContext {
		public TerminalNode T_ISO_10303_21() { return getToken(IFCParser.T_ISO_10303_21, 0); }
		public IsoTagContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_isoTag; }
		@Override
		public void enterRule(ParseTreeListener listener) {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof IFCVisitor ) return ((IFCVisitor<? extends T>)visitor).visitIsoTag(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ExprContext extends ParserRuleContext {
		...
		public List<TerminalNode> T_DOT() { return getTokens(IFCParser.T_DOT); }
		...
		public TerminalNode T_OPEN_P() { return getToken(IFCParser.T_OPEN_P, 0); }
		...
		public TerminalNode T_CLOSE_P() { return getToken(IFCParser.T_CLOSE_P, 0); }
		public List<TerminalNode> T_COMMA() { return getTokens(IFCParser.T_COMMA); }
		public TerminalNode T_COMMA(int i) {
			return getToken(IFCParser.T_COMMA, i);
		}
		public TerminalNode T_MUL() { return getToken(IFCParser.T_MUL, 0); }
		public TerminalNode T_DIV() { return getToken(IFCParser.T_DIV, 0); }
		public TerminalNode T_ADD() { return getToken(IFCParser.T_ADD, 0); }
		public TerminalNode T_SUB() { return getToken(IFCParser.T_SUB, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof IFCVisitor ) return ((IFCVisitor<? extends T>)visitor).visitExpr(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ExprAtomContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof IFCVisitor ) return ((IFCVisitor<? extends T>)visitor).visitExprAtom(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ExprFuncContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof IFCVisitor ) return ((IFCVisitor<? extends T>)visitor).visitExprFunc(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ExprFuncParamsContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof IFCVisitor ) return ((IFCVisitor<? extends T>)visitor).visitExprFuncParams(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class FuncParamContext extends ParserRuleContext {
		...
		public TerminalNode T_MUL() { return getToken(IFCParser.T_MUL, 0); }
		public TerminalNode T_DOLLAR() { return getToken(IFCParser.T_DOLLAR, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof IFCVisitor ) return ((IFCVisitor<? extends T>)visitor).visitFuncParam(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class IdentContext extends ParserRuleContext {
		public TerminalNode L_ID() { return getToken(IFCParser.L_ID, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof IFCVisitor ) return ((IFCVisitor<? extends T>)visitor).visitIdent(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class SingleQuotedStringContext extends StringContext {
		public TerminalNode L_S_STRING() { return getToken(IFCParser.L_S_STRING, 0); }
		public SingleQuotedStringContext(StringContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof IFCListener ) ((IFCListener)listener).enterSingleQuotedString(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof IFCListener ) ((IFCListener)listener).exitSingleQuotedString(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof IFCVisitor ) return ((IFCVisitor<? extends T>)visitor).visitSingleQuotedString(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class DoubleQuotedStringContext extends StringContext {
		public TerminalNode L_D_STRING() { return getToken(IFCParser.L_D_STRING, 0); }
		public DoubleQuotedStringContext(StringContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof IFCListener ) ((IFCListener)listener).enterDoubleQuotedString(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof IFCListener ) ((IFCListener)listener).exitDoubleQuotedString(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof IFCVisitor ) return ((IFCVisitor<? extends T>)visitor).visitDoubleQuotedString(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class IntNumberContext extends ParserRuleContext {
		public TerminalNode L_INT() { return getToken(IFCParser.L_INT, 0); }
		public TerminalNode T_SUB() { return getToken(IFCParser.T_SUB, 0); }
		public TerminalNode T_ADD() { return getToken(IFCParser.T_ADD, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof IFCVisitor ) return ((IFCVisitor<? extends T>)visitor).visitIntNumber(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class DecNumberContext extends ParserRuleContext {
		public TerminalNode L_DEC() { return getToken(IFCParser.L_DEC, 0); }
		public TerminalNode T_SUB() { return getToken(IFCParser.T_SUB, 0); }
		public TerminalNode T_ADD() { return getToken(IFCParser.T_ADD, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof IFCVisitor ) return ((IFCVisitor<? extends T>)visitor).visitDecNumber(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ScientificCountingNumberContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_scientificCountingNumber; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof IFCListener ) ((IFCListener)listener).enterScientificCountingNumber(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof IFCListener ) ((IFCListener)listener).exitScientificCountingNumber(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof IFCVisitor ) return ((IFCVisitor<? extends T>)visitor).visitScientificCountingNumber(this);
			else return visitor.visitChildren(this);
		}
	}

	public final ScientificCountingNumberContext scientificCountingNumber() throws RecognitionException {
		ScientificCountingNumberContext _localctx = new ScientificCountingNumberContext(_ctx, getState());
	...
	public static class BoolLiteralContext extends ParserRuleContext {
		public TerminalNode T_TRUE() { return getToken(IFCParser.T_TRUE, 0); }
		public TerminalNode T_FALSE() { return getToken(IFCParser.T_FALSE, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof IFCVisitor ) return ((IFCVisitor<? extends T>)visitor).visitBoolLiteral(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class NullConstContext extends ParserRuleContext {
		public TerminalNode T_NULL() { return getToken(IFCParser.T_NULL, 0); }
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof IFCVisitor ) return ((IFCVisitor<? extends T>)visitor).visitNullConst(this);
			else return visitor.visitChildren(this);
		}
	}
