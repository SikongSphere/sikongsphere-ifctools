...
-  <a href="#overall">一、概述</a>
- <a href="#objectives">1.1 目标</a>
  - <a href="#strategy">1.2 发展战略</a>
  
-  <a href="#spec">二、ifcJSON 文档规范</a>
...
## <div id="overall">一、概述</div>

### <div id="objectives">1.1 目标</div>
...
## <div id="spec">二、ifcJSON文档规范</div>

下文为 ifcJSON 提供了更详细的规范。我们在此不提供完整的架构，而是列出一些一般性原则。

### <div id="key">2.1 必需的对象、键或实体</div>
...
### <div id="value">2.2 空值、userdefined 值和notdefined值</div>
...
### <div id="header">2.3 文件头</div>

文件头包含在 IFCJSON 文件中，是 SPF 文件中第一部分的直接翻译。

### <div id="identifier">2.4 标识符</div>
...
### <div id="name">2.6 camelCase、CamelCaps 或 snake_case</div>
...
### <div id="extension">2.7 PredefinedTypes和ObjectTypes and Types</div>
...
## <div id="schema">三、ifcJSON schema</div>
