...
public class IfcWallFactory extends AbstractFactory<IfcWall> {
    ...
    public IfcWallStandardCase createStandardWall(IOrder<IfcWall> order) {
        ...
        IfcText representationDescription = new IfcText("IfcWallStandardCase representation description");
        LIST<IfcRepresentation> representations = new LIST<>(axisRepresentation,bodyRepresentation);
