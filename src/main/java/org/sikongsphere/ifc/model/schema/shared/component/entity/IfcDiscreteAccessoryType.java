...
/**
 *  The element type (IfcDiscreteAccessoryType) defines a list of commonly shared property set definitions of a discrete
 *  accessory and an optional set of product representations. It is used to define a supporting element mainly within
 *  structural and building services domains (i.e. the specific type information common to all occurrences of that type).
 * @author Kuang Tianyu
