...
import org.sikongsphere.ifc.model.schema.shared.building.enumeration.IfcBeamTypeEnum;

/**
 * The element type (IfcBeamType) defines a list of commonly shared property set definitions of a beam and an optional
 * set of product representations. It is used to define a beam specification (i.e. the specific product information that
