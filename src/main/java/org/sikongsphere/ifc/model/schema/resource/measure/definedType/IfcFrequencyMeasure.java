...
/**
 *  A measure of the number of times that an item vibrates in unit time.
 * @author zaiyuan
 * @date 2022/12/07 21:38
 */
@IfcClass(type = IfcType.ENTITY, layer = IfcLayer.RESOURCE)
public class IfcFrequencyMeasure extends REAL {
    ...
    public IfcFrequencyMeasure(STRING value) {
        super(value);
    }
}
