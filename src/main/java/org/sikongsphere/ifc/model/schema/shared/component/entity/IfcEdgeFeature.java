...
import org.sikongsphere.ifc.model.schema.extension.product.entities.IfcFeatureElementSubtraction;
...
public class IfcEdgeFeature extends IfcFeatureElementSubtraction {
    @IfcOptionField
    private IfcPositiveLengthMeasure featureLength;
    ...
    public void setFeatureLength(IfcPositiveLengthMeasure featureLength) {
        this.featureLength = featureLength;
    }
