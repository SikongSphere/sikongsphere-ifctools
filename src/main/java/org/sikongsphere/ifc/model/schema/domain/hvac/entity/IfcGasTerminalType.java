...
import org.sikongsphere.ifc.model.schema.domain.hvac.enumeration.IfcGasTerminalTypeEnum;
...
public class IfcGasTerminalType extends IfcFlowTerminalType {
    private IfcGasTerminalTypeEnum predefinedType;
    ...
    public void setPredefinedType(IfcGasTerminalTypeEnum predefinedType) {
        this.predefinedType = predefinedType;
    }
}
