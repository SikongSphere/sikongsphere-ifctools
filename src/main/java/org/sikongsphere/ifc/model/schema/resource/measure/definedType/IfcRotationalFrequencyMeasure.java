...
/**
 * A measure of the number of cycles that an item revolves in unit time.
 * @author zaiyuan
 * @date 2022/12/07 21:38
 */
@IfcClass(layer = IfcLayer.RESOURCE, type = IfcType.DEFINED_TYPE, isStepElement = false)
public class IfcRotationalFrequencyMeasure extends REAL implements IfcDerivedMeasureValue {
    ...
    public IfcRotationalFrequencyMeasure(STRING value) {
        super(value);
    }
}
