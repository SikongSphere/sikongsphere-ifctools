...
import org.sikongsphere.ifc.model.schema.shared.sharedbldgelements.enumeration.IfcColumnTypeEnum;

/**
 * The element type (IfcColumnType) defines a list of commonly shared property set definitions of a column and an
 * optional set of product representations. It is used to define a column specification (i.e. the specific product
