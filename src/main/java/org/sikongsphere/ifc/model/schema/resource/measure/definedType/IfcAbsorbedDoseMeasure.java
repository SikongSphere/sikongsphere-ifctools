...
/**
 * A measure of the absorbed radioactivity dose.
 * @author zaiyuan
 * @date 2022/12/07 21:38
 */
@IfcClass(layer = IfcLayer.RESOURCE, type = IfcType.DEFINED_TYPE, isStepElement = false)
public class IfcAbsorbedDoseMeasure extends REAL implements IfcDerivedMeasureValue {
    ...
    public IfcAbsorbedDoseMeasure(STRING value) {
        super(value);
    }
}
