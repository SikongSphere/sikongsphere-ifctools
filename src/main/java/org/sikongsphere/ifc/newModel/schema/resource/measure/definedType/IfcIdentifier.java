...
import org.sikongsphere.ifc.newModel.schema.resource.measure.selectTypes.IfcSimpleValue;
...
public class IfcIdentifier extends STRING implements IfcValue, IfcSimpleValue {
    /**
    ...
    public IfcIdentifier(IfcIdentifier value) {
        super(value.value);
    }
}
